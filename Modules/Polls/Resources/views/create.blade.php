...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li><i class="fa fa-dashboard"></i> <a href="{{route('backend.dashboard')}}">{{trans('menu.sidebar.dashboard')}}</a></li>
     <li><a href="{{route($model.'.index')}}">@lang($model.'::menu.sidebar.menu_title') @lang('menu.manager')</a></li>
  ...
  <div class="box box-success">
    ...
    <div class="box-footer">
       <div class="row pull-right">
          <div class="col-sm-12">
             <button class="btn btn-primary" id="loanQuestionaree" type="submit">{{trans('menu.sidebar.create')}}</button>
